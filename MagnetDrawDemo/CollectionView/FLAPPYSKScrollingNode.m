...
@implementation FLAPPYSKScrollingNode
...
+ (id) scrollingNodeWithImageNamed:(NSString *)name inContainerWidth:(float) width
{
    ...
    FLAPPYSKScrollingNode * realNode = [FLAPPYSKScrollingNode spriteNodeWithColor:[UIColor clearColor] size:CGSizeMake(width, image.size.height)];
...
-(void)update:(NSTimeInterval)currentTime{
    [self.children enumerateObjectsUsingBlock:^(SKNode * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        //cast the SKNode as SKSpriteNode
